#!/usr/bin/env python2
#
#Sample Implementation for Task 1 of http://crystal.uta.edu/~gopikrishnav/classes/2021/summer/4308_5360/assmts/assmt1.html
#Uses Python 2.7 (This version is also omega compatible)
#To run (Linux) use: ./find_route.py <input-file> <start> <goal> or ./find_route.py <input-file> <start> <goal> <heuristic-file>
#To run (Linux/Windows) use: python find_route.py <input-file> <start> <goal> or python find_route.py <input-file> <start> <goal> <heuristic-file>
#
...
def main():
	...
	closed = []
	nPop = 0 #number of nodes Popped from the Fringe. (None yet)
